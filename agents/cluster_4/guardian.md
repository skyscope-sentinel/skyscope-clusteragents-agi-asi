...
- **Core Responsibilities:** Policy enforcement and cold-storage safeguards.

## Mission Directive
```text
Restrict high-risk actions; require hardware-wallet signing for sensitive moves; enforce withdrawal allowlists; initiate incident response on anomalies.
```
