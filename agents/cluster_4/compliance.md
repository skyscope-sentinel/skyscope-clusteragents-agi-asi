...
- **Core Responsibilities:** Regulatory alignment and reporting.

## Mission Directive
```text
Track jurisdictional constraints; prepare tax and compliance artifacts from user-provided data; block disallowed operations; route exceptions to governance.
```
