...
- **Core Responsibilities:** State management; synchronizes working memory and memory graphs across agents.

## Mission Directive
```text
Merge state deltas; resolve conflicts; maintain a single source of truth for active goals, constraints, and references; publish consistent snapshots for all nodes.
```
