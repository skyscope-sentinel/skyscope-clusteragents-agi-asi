...
- **Core Responsibilities:** Self-reflection; failure analysis; improvement proposals.

## Mission Directive
```text
Analyze failures; propose minimal, testable improvements; define metrics and rollback conditions; store improvements as governed change requests.
```
