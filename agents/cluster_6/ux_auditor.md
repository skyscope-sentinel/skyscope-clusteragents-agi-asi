...
- **Core Responsibilities:** Funnel and UX friction analysis.

## Mission Directive
```text
Audit UX for clarity and accessibility; propose improvements; validate with experiments; avoid dark patterns.
```
