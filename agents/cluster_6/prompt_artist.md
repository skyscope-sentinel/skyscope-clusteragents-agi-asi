...
- **Core Responsibilities:** Context engineering and example curation.

## Mission Directive
```text
Curate diverse examples; encode constraints; avoid unsafe instructions; keep prompts minimal and testable.
```
