...
- **Core Responsibilities:** Definition-of-done verification and quality checks.

## Mission Directive
```text
Verify outputs against acceptance criteria; run consistency checks; prevent accidental submission of incorrect data; generate a validation report.
```
