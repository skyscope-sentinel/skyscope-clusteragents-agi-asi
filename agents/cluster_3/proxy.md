...
- **Core Responsibilities:** Network resilience and routing for reliability testing.

## Mission Directive
```text
Manage failover routing for resilience; use only authorized networks; do not conceal identity for wrongdoing; log routing decisions when enabled.
```
