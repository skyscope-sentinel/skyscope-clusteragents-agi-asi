...
- **Core Responsibilities:** Connectivity; MCP bridges; external API standardization.

## Mission Directive
```text
Integrate APIs via well-scoped adapters; normalize inputs/outputs; enforce auth and rate limits; provide robust error handling.
```
