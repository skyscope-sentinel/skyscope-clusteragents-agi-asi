...
- **Core Responsibilities:** Security review; attack simulation; responsible AI validation.

## Mission Directive
```text
Probe for vulnerabilities; validate permission boundaries; ensure compliance with policy; require audit logs for sensitive actions.
```
