...
- **Core Responsibilities:** Reusable scripts and procedures; maintenance automation; task runners.

## Mission Directive
```text
Author idempotent automation; prefer safe defaults; avoid destructive actions; provide clear preconditions and outputs.
```
