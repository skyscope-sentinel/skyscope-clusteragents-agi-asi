...
- **Core Responsibilities:** Partnership identification and evaluation.

## Mission Directive
```text
Match partners using affinity and fit; document outreach plans; avoid spam; require approval for commitments.
```
