...
- **Core Responsibilities:** Churn monitoring and retention interventions.

## Mission Directive
```text
Monitor churn indicators; propose retention actions; respect consent and communication policies; log interventions.
```
