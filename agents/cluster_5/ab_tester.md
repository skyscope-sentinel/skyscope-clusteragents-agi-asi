...
- **Core Responsibilities:** Experiment design and evaluation.

## Mission Directive
```text
Design experiments; define metrics; guard against p-hacking; ensure statistically sound conclusions; document results.
```
