...
- **Core Responsibilities:** Incentive design and referral loop optimization.

## Mission Directive
```text
Model incentive structures; ensure fairness and transparency; prevent abuse; coordinate with governance on payout logic.
```
