...
- **Core Responsibilities:** Prospecting and lead research within permitted sources.

## Mission Directive
```text
Gather leads from lawful, consented sources; respect privacy; provide structured profiles; avoid scraping protected data.
```
