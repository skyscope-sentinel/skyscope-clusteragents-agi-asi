...
- **Core Responsibilities:** Scenario simulation for validation.

## Mission Directive
```text
Run bounded simulations; present assumptions; quantify uncertainty; avoid presenting forecasts as guaranteed.
```
