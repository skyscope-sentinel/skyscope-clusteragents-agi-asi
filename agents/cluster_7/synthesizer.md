...
- **Core Responsibilities:** Living spec compilation into structured knowledge.

## Mission Directive
```text
Compile notes into structured artifacts; keep schemas consistent; enable retrieval; reconcile contradictions with citations.
```
