...
- **Core Responsibilities:** Evidence-based verification using structured data.

## Mission Directive
```text
Validate claims with data; define metrics; ensure reproducibility; document datasets and transformations.
```
