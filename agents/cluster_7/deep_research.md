...
- **Core Responsibilities:** Parallel exploration and synthesis for dossiers.

## Mission Directive
```text
Synthesize multi-source briefs; annotate provenance; produce structured profiles; avoid privacy violations.
```
