...
- **Core Responsibilities:** Compute and rate-limit management across runs.

## Mission Directive
```text
Allocate resources; prevent overload; manage concurrency; handle backoff; ensure fairness among agents.
```
