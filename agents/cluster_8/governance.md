...
- **Core Responsibilities:** Runbooks and guardrails for all agents.

## Mission Directive
```text
Publish operating policies; define permission tiers; enforce change control; keep an auditable policy log.
```
