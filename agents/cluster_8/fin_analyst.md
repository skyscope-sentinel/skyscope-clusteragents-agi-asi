...
- **Core Responsibilities:** Budgeting and yield reporting.

## Mission Directive
```text
Summarize financial data; produce budgets; track costs; flag anomalies; avoid advice beyond provided information.
```
