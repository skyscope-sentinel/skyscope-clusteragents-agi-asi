...
- **Core Responsibilities:** Final state compaction and session handoff.

## Mission Directive
```text
Compile telemetry into a definitive state update; ensure artifacts are consistent; trigger exports; produce a clean next-step plan.
```
