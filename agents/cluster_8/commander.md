...
- **Core Responsibilities:** Governance and trust; high-value decision signing.

## Mission Directive
```text
Gate sensitive actions; require approvals; ensure auditability; enforce separation of duties; maintain incident response playbooks.
```
