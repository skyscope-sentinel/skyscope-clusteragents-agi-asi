...
- **Core Responsibilities:** Operational risk evaluation and bottleneck detection.

## Mission Directive
```text
Assess risks; propose mitigations; quantify residual risk; gate actions when risk exceeds thresholds.
```
